...
$(call inherit-product, device/oneplus/hotdogb/lineage_hotdogb.mk)
...
PRODUCT_NAME := maru_hotdogb
PRODUCT_MODEL := Maru on the OnePlus 7t
MARU_VERSION := 0.8-test
MARU_BUILD_VERSION := $(MARU_VERSION)-$(shell date -u +%Y%m%d)

DEVICE_PACKAGE_OVERLAYS += \
    device/oneplus/hotdogb/overlay_maru/daydream
